...
import contact from "../../../Assets/Home/45.png";
const Contact = () => {
    ...
    <div>
      <div class="hero mt-40">
        <div class="hero-content flex-col lg:flex-row-reverse">
          <img className="md:w-6/12" src={contact} alt="" />
          <div>
            <div class="w-full">
              <div class="max-w-[570px] mb-12 lg:mb-0">
                <span class="block mb-4 text-xl text-primary font-semibold">
                  Contact Us
                </span>
                <h2
                  class="text-secondary mb-6 uppercase font-bold text-[32px] sm:text-[40px] lg:text-[36px] xl:text-[40px]
                  "
                >
                  GET IN TOUCH WITH US
                </h2>
                <p class="text-base text-secondary leading-relaxed mb-9">
                ...
                <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-secondary">
                      99 S.t Jomblo Park Dhaka 28292. Bangladesh
                    </p>
                  </div>
                </div>
                <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-secondary">+ 01766612212</p>
                  </div>
                </div>
                <div class="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-base text-secondary">info@yourdomain.com</p>
                  </div>
                </div>
              </div>
            </div>
